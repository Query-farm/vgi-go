...
func derivedRecordCases() []derivedRecordCase {
	return []derivedRecordCase{
		...
		{"TableFunctionStatisticsRequest", reflect.TypeOf(CardinalityRequestWire{}), generated.TableFunctionStatisticsRequestSchema},
		{"TableFunctionDynamicToStringRequest", reflect.TypeOf(TableFunctionDynamicToStringRequestWire{}), generated.TableFunctionDynamicToStringRequestSchema},
		{"CatalogCreateRequest", reflect.TypeOf(CatalogCreateRequestWire{}), generated.CatalogCreateRequestSchema},
		{"MacroCreateRequest", reflect.TypeOf(MacroCreateRequestWire{}), generated.MacroCreateRequestSchema},
		{"TableCreateRequest", reflect.TypeOf(TableCreateRequestWire{}), generated.TableCreateRequestSchema},
		...
		{"AggregateWindowInitRequest", reflect.TypeOf(AggregateWindowInitRequestWire{}), generated.AggregateWindowInitRequestSchema},
		{"AggregateWindowRequest", reflect.TypeOf(AggregateWindowRequestWire{}), generated.AggregateWindowRequestSchema},
		{"AggregateWindowBatchRequest", reflect.TypeOf(AggregateWindowBatchRequestWire{}), generated.AggregateWindowBatchRequestSchema},
		{"AggregateWindowDestructorRequest", reflect.TypeOf(AggregateWindowDestructorRequestWire{}), generated.AggregateWindowDestructorRequestSchema},
		{"AggregateStreamingOpenRequest", reflect.TypeOf(AggregateStreamingOpenRequestWire{}), generated.AggregateStreamingOpenRequestSchema},
		{"AggregateStreamingChunkRequest", reflect.TypeOf(AggregateStreamingChunkRequestWire{}), generated.AggregateStreamingChunkRequestSchema},
		{"AggregateStreamingCloseRequest", reflect.TypeOf(AggregateStreamingCloseRequestWire{}), generated.AggregateStreamingCloseRequestSchema},
