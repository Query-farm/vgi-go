...
func registerTables(w *vgi.Worker) {
	...
	w.RegisterTable(table.NewBoolFilterEchoFunction())
	...
	w.RegisterTable(table.NewSplitPaginatedFunction())
	w.RegisterTable(table.NewSplitStalePlanFunction())
	w.RegisterTable(table.NewSplitShortTtlFunction())
	w.RegisterTable(table.NewSplitBatchIndexFunction())
	w.RegisterTable(table.NewSplitCacheableFunction())
	w.RegisterTable(table.NewSplitPartitionedFunction())
	w.RegisterTable(table.NewSplitDynamicFilterFunction())
	w.RegisterTable(table.NewSplitFailAtFunction())
	w.RegisterTable(table.NewSplitEndlessCursorFunction())
	w.RegisterTable(table.NewSplitEchoFiltersFunction())
...
func registerTableInOuts(w *vgi.Worker) {
	...
	w.RegisterTableInOut(table_in_out.NewMultiBatchFinishFunction())
